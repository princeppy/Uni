...
--07.Define function in the SoftUni database.
...
--09.Define a .NET aggregate function
		...
		AUTHORIZATION dbo
		FROM 'D:\Marto\Google Drive\SoftUni\Databases\06.T-SQL\Aggregate\Aggregate\Aggregate\bin\Release\Aggregate.dll'  --- Please be sure that the dll file is here
